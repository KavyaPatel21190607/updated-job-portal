...
const getMyApplications = async (req, res, next) => {
  try {
    ...
    return paginatedResponse(res, 200, 'Your applications retrieved successfully', applications, {
      page: pageNum,
      limit: limitNum,
      totalPages,
      totalItems,
...
const getEmployerApplications = async (req, res, next) => {
  try {
    ...
    return paginatedResponse(res, 200, 'Applications retrieved successfully', applications, {
      page: pageNum,
      limit: limitNum,
      totalPages,
      totalItems,
